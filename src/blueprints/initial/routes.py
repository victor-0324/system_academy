...
def inadimplentes():
    ...
    return render_template("pages/adm/home/inadimplentes.jinja", 
                           quantidade_alunos=quantidade_alunos, 
                           manifest=manifest,
                           **dados_alunos)
...
def pagamsemana():
    ...
    return render_template("pages/adm/home/pagamsemana.jinja", 
                           quantidade_alunos=quantidade_alunos, 
                           manifest=manifest,
                           **dados_alunos)
...
def atualizarmedidas():
    ...
    return render_template("pages/adm/home/atualizarmedidas.jinja", 
                            **dados_alunos,
                            quantidade_alunos=quantidade_alunos, 
                            manifest=manifest)
